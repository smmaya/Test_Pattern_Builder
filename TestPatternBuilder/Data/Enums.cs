...
public enum Types
{
    ...
    [Display(Name = "Date (Timestamp)")] Date_Timestamp,
    [Display(Name = "Float/Decimal")] Float_Double_Decimal,
    String
}
...
{
    Exploration,
    [Display(Name = "Issue Related")] Issue_Related,
    Regression,
    Acceptance,
    Sanity
}
...
public enum Components
{
    Auth,
    Backend,
    [Display(Name = "Middle Layer")] Middle_Layer,
    Visualisations,
    [Display(Name = "UX/UI")] UX_UI,
    Other
}
...
{
    Snowflake,
    [Display(Name = "Google Sheets")] GoogleSheets,
    PostgreSQL,
    [Display(Name = "Google BigQuery")] GoogleBigQuery,
    Dremio,
    Databricks,
    Redshift
}
...
{
    [Display(Name = "Printing")] Printing = 1,
    [Display(Name = "Embedability")] Embeds = 2,
    ...
    [Display(Name = "Theming")] Theming = 512
}